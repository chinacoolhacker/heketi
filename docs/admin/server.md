...
## Examples
* [Mock setup](https://github.com/chinacoolhacker/heketi/blob/master/etc/heketi.json)
* ~~[Functional test setup](https://github.com/chinacoolhacker/heketi/blob/master/tests/functional/large/config/heketi.json)~~
